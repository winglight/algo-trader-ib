...
BROKER_CREDENTIAL_KEK="$(read_env_value "$ROOT_CANDIDATE" BROKER_RUNNER_CREDENTIAL_KEY)"
...
env_set_quoted "$ROOT_CANDIDATE" BROKER_RUNNER_CREDENTIAL_KEY "$BROKER_CREDENTIAL_KEK"
env_set "$ROOT_CANDIDATE" BROKER_RUNNER_CREDENTIAL_KEY_VERSION v1
...
for key in ATI_NETWORK_NAME ATI_IB_GATEWAY_CONTAINER_NAME; do
